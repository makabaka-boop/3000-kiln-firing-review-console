...
export type Batch={id:string;name:string;kiln:string;recipeId:string;start:string;notes:string;samples:Sample[];reviews:Record<string,Review>;referenceBatchId?:string};
